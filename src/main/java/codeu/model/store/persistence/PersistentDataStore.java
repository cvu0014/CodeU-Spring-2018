...
public class PersistentDataStore {
  ...
  public List<Conversation> loadConversations() throws PersistentDataStoreException {
    ...
    for (Entity entity : results.asIterable()) {
      try {
        ...
        Instant creationTime = Instant.parse((String) entity.getProperty("creation_time"));
        List<String> tags = (List<String>) entity.getProperty("conversation-tags");
        Conversation conversation = new Conversation(uuid, ownerUuid, title, creationTime, tags);
  ...
  */
  ...
  public void writeThrough(Conversation conversation) {
    ...
    conversationEntity.setProperty("conversation-tags", conversation.getTags());
